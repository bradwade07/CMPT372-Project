...
app.post("/postUser", async (req, res) => {
  ...
  let type_id = user_type === "vendor"
    ? 1
    : 2; // FIXME: type to type_id logic
...
app.patch("/patchUserType", async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({success: "User type modified successfully!"});
  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({error: "Server failed to modify user type!"});
  }
});
...
app.patch("/patchUserAddress", async (req, res) => {
  ...
  try {
    ...
    return res.status(200).send({success: "User address modified successfully!"});
  } catch (error) {
    console.error("Error:", error);
    return res.status(500).send({error: "Server failed to modify user address!"});
  }
});
...
app.post("/postProductToUserWishlist", async (req, res) => {
  ...
  try {
    ...
    return res.status(200).send({success: "Item added to user wishlist successfully!"});
  } catch (error) {
    console.error("Error:", error);
    return res.status(500).send({error: "Server failed to add product to the user wishlist!"});
  }
});
...
app.get("/getUserWishlistByUserEmail/:user_email", async (req, res) => {
  ...
  try {
    ...
    return res.status(500).send({error: "Server failed to get user wishlist!"});
  }
});
...
app.delete("/deleteUserWishlistByPidUserEmail", async (req, res) => {
  ...
  try {
    ...
    return res.status(200).send({success: "Item removed from user wishlist successfully!"});
  } catch (error) {
    console.error("Error:", error);
    return res.status(500).send({error: "Server failed to delete product from user wishlist!"});
  }
});
...
app.post("/postProductToUserCart", async (req, res) => {
  ...
  try {
    ...
    return res.status(200).send({success: "Item added to user cart successfully!"});
  } catch (error) {
    console.error("Error:", error);
    return res.status(500).send({error: "Server failed to add product to the user cart!"});
  }
});
...
app.delete("/deleteUserCartByPidUserEmail", async (req, res) => {
  ...
  try {
    ...
    return res.status(200).send({success: "Item removed from user cart successfully!"});
  } catch (error) {
    console.error("Error:", error);
    return res.status(500).send({error: "Server failed to delete prodcut from user cart!"});
  }
});
...
app.patch("/patchWarehouseStock", async (req, res) => {
  ...
  try {
    ...
    if (response === 1) {
      return res.status(200).send({success: "Warehouse quantity modified successfully!"});
    }
    return res.status(400).json({error: "Warehouse quantity is less than desired quantity!"});
  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({error: "Server failed to modify warehouse quantity!"});
  }
});
...
app.post("/api/orders", async (req, res) => {
  try {
    ...
    const {jsonResponse, httpStatusCode} = await createOrder(user_email, acquisitionMethod);
...
app.post("/createProductListing", async (req, res) => {
  try {
    ...
    warehouse_ids.pop();
    quantities.pop();
    await helpers.createProductListing(product_name, product_description, base_price, current_price, user_email, warehouse_ids, quantities, product_images);
